...
//   return (
//     <div className="text-white text-2xl md:text-4xl font-bold text-center mb-16 px-4 flex flex-wrap justify-center">
...
const Banner = () => {
  return (
    <div className="w-full flex justify-center py-10">
      <div className="carousel w-11/12 lg:w-4/5 h-[70vh] rounded-xl shadow-lg overflow-hidden">
        {/* Slide 1 */}
        <div id="slide1" className="carousel-item relative w-full">
          <img
            src={banner1}
