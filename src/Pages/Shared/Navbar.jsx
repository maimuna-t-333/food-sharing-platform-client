...
//             <div className="navbar bg-[#5e7784] shadow-sm px-3 py-6 lg:px-14">
...
//                     <img className="w-10 h-10 lg:w-12 lg:h-12 ml-2 rounded-b-full " src={logo} alt="Food Logo" />
//                 </div>
...
//                             <button
//                                 onClick={handleLogout}
//                                 className="text-white text-xl font-bold hover:cursor-pointer hidden md:block "
//                             >
//                                 Logout
//                             </button>
